    ...
    return Scaffold(
      ...
      body: Padding(padding: EdgeInsets.all(8.0),
        child: GridView.builder(
          ...
          return
            HotelGridView(hotel: singleHotel,
          );
            }),
      ),
    );
      ...
      child: Column(
        ...
        [AspectRatio( aspectRatio: 1.5,
          ...
          Padding(padding: const EdgeInsets.only(left: 15),
              child:
              Text(
                hotel['image'], style: AppStyles.headline2.copyWith(color: Colors.white),
              )
          ),
         Row(
           children: [
        ...
        Padding(padding: const EdgeInsets.only(left: 15),
          child:
          Text(
            '\$${hotel['price']}/night', style: AppStyles.headline2.copyWith(color: Colors.white),
          )
        )
           ],
         ),
